...
public class FileManagerView extends JFrame {
    ...
    private void displayFileView() {
        ...
        contentPanel.add(new JScrollPane(table)); // Ajouter la table des fichiers PDF
    }
    ...
    private void displayMetierView() {
        ...
        contentPanel.add(new JScrollPane(table)); // Ajouter la table des métiers
    }
    ...
    private void displayCategorieView() {
        ...
        contentPanel.add(categorieManagerView); // Ajouter la vue de gestion des catégories dans le panneau principal
    }
